...
the_avengers = media.Movie("The Avengers", "Earth's mightiest heroes must \
...
avengers = media.Movie("Avengers: Age of Ultron", "When Tony Stark and Bruce \
                        Banner try to jump-start a dormant peacekeeping \
                        program called Ultron, things go horribly wrong and \
                        it's up to Earth's Mightiest Heroes to stop the \
...
iron_man = media.Movie("Iron Man", "After being held captive in an Afghan \
                        cave, an industrialist creates a unique weaponized \
...
iron_man_2 = media.Movie("Iron Man 2", "With the world now aware of his \
                          identity as Iron Man, Tony Stark must contend with \
                          both his declining health and a vengeful mad man \
...
iron_man_3 = media.Movie("Iron Man 3", "When Tony Stark's world is torn \
                          apart by a formidable terrorist called the \
                          Mandarin, he starts an odyssey of rebuilding and \
                          retribution.",
...
hulk = media.Movie("The Incredible Hulk", "Bruce Banner, a scientist on the \
                    run from the U.S. Government must find a cure for the \
                    monster he emerges whenever he loses his temper. \
                    However, Banner then must fight a soldier whom \
                    unleashes himself as a threat stronger than he.",
...
holmes_1 = media.Movie("Sherlock Holmes", "Detective Sherlock Holmes and \
                        his stalwart partner Watson engage in a battle of \
                        wits and brawn with a nemesis whose plot is a threat \
                        to all of England.",
...
holmes_2 = media.Movie("Sherlock Holmes: A Game of Shadows", "Sherlock \
                        Holmes and his sidekick Dr. Watson join forces to \
                        outwit and bring down their fiercest adversary, \
                        Professor Moriarty.",
...
dawn_of_the_apes = media.Movie("Dawn of the Planet of the Apes", "A growing \
                                nation of genetically evolved apes led by \
                                Caesar is threatened by a band of human \
                                survivors of the devastating virus unleashed \
                                a decade earlier.",
...
rise_of_the_apes = media.Movie("Rise of the Planet of the Apes", "A \
                                substance, designed to help the brain repair \
                                itself, gives rise to a super-intelligent \
...
lucy = media.Movie("Lucy", "A woman, accidentally caught in a dark deal, \
                    turns the tables on her captors and transforms into a \
...
movies = [the_avengers, avengers, iron_man, iron_man_2, iron_man_3, hulk,
          holmes_1, holmes_2, dawn_of_the_apes,
          rise_of_the_apes, lucy]
